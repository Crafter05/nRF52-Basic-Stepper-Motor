...
INC_FOLDERS += \
  $(SDK_ROOT)/Nordic_SDK_15.2.0_components/toolchain/cmsis/include \
  $(PROJ_DIR)/micro-ecc \
...
TEMPLATE_PATH := $(SDK_ROOT)/Nordic_SDK_15.2.0_components/toolchain/gcc
...
CMSIS_CONFIG_TOOL = $(SDK_ROOT)/Nordic_SDK_15.2.0_external_tools/cmsisconfig/CMSIS_Configuration_Wizard.jar
sdk_config:
